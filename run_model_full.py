...
if not os.path.exists('full_model_fits'):
    os.makedirs('full_model_fits')
...
train_inds = [i for j in range(n_folds) for i in fold_inds[j]]
...
for epoch in range(epochs):
    ...
    model.save_weights('full_model_fits/{}.h5'.format(K))
